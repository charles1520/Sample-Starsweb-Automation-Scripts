...
public class auto_login_logout {
	...
	public static void takeSs(WebDriver driver, String user){
		// Take screenshot and store as a file format
		File src= ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		try {
			//Copy screenshot to desired location using copyFile method
			FileUtils.copyFile(src, new File("./Screenshots/"+user+".png"));
		}
	...
	public static void main(String[] args) throws Exception {	
		...
		for (int i = 0; i<account_list.size();++i){
			...
			try {
				...
				takeSs (driver, account_list.get(i));
